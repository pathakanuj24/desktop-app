...
def open_login_page():
    ...
    # Check if search page window is already open
    if 'search_window' in globals():
        search_window.lift()
        return
...
class Sidebar(tk.Frame):
    def __init__(self, master=None, *args, **kwargs):
        ...
        # Settings button
        settings_button = tk.Button(self, text="Settings", command=open_login_page)
        settings_button.pack(pady=10)

    def slide_out(self):
        self.master.pack_slaves()[0].pack_forget()
        self.master.master.geometry("200x400")

        # Destroy the search page window
